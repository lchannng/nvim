    ...
    function(use)
      ...
      use {
        ...
        config = function()
          ...
          keymaps.noremap('<F9>', ':PackerCompile<CR>')
          keymaps.noremap('<F10>', ':PackerSync<CR>')
        end
      }
      ...
      use {
        ...
        config = function()
          ...
          local keymaps = require("keymaps")
          keymaps.noremap('<leader>hb', '<cmd>lua require"gitsigns".blame_line{full=true}<CR>')
        end
      }
      ...
      use {
        ...
        config = function()
          local keymaps = require("keymaps")
          keymaps.noremap('<F11>', ':call Autopep8()<CR>')
        end,
      }
